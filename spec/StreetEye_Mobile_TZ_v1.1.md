...
Четыре категории: «Визуальное», «Техническое», «Социальное», «Ограничения». Мультивыбор, минимум 1, максимум 2. Сохраняется в `settings.store`.
...
// Принять задание — создать сессию (при нажатии «Взять это» / «Пошёл снимать»)
